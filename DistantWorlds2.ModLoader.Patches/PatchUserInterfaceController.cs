...
public class PatchUserInterfaceController
{
    ...
    public static bool PrefixShowFileDialogCentered(string title, string text, ref IVirtualFileProvider fileProvider, ref string subFolder,
        FileType fileTypeFilter)
    {
        ...
        switch (fileTypeFilter)
        {
            case FileType.FleetTemplates: {
                if (subFolder == "Fleet Templates")
                    subFolder = "FleetTemplates";
                break;
            }
